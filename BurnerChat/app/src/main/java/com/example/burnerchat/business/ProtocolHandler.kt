...
import com.example.burnerchat.business.handlers.MessageHandler
import com.example.burnerchat.business.handlers.RTCManagerHandler
import com.example.burnerchat.business.handlers.SocketHandler
...
//        socketHandler.startListening(scope)
    ...
    fun handleNewMessage(message: MessageModel) {
